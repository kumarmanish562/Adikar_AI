...
import { BookOpen, Download, FileText, ExternalLink, Gavel, Users } from 'lucide-react';
...
const Resources = () => {
    ...
    const resourceList = [
        {
            title: t('resources.constitution'),
            type: t('resources.typeDocument'),
            size: "1.2 MB",
            link: "#",
            icon: <FileText className="w-6 h-6 text-primary" />
        },
        {
            title: t('resources.bns'),
            type: t('resources.typeAct'),
            size: "4.5 MB",
            link: "#",
            icon: <Gavel className="w-6 h-6 text-primary" />
        },
        {
            title: t('resources.consumer'),
            type: t('resources.typeGuide'),
            size: "800 KB",
            link: "#",
            icon: <BookOpen className="w-6 h-6 text-primary" />
        },
        {
            title: t('resources.family'),
            type: t('resources.typeBrochure'),
            size: "2.1 MB",
            link: "#",
        ...
        <div className="pt-24 pb-16 px-4">
            <div className="max-w-7xl mx-auto">
                <section className="text-center mb-16">
                    ...
                    >
                        {t('nav.resources')} <span className="text-secondary italic">{t('auth.appName')}</span>
                    </motion.h1>
                    ...
                    {resourceList.map((res, index) => (
                        ...
                        >
                            <div>
                                ...
                                <p className="text-slate-500 text-sm mb-6">{t('resources.size', { size: res.size })}</p>
                            </div>
                ...
                <section className="bg-primary text-white p-12 rounded-3xl text-center">
                    <h2 className="text-3xl font-bold mb-4">{t('resources.portalsTitle')}</h2>
                    <p className="text-blue-100 mb-10 max-w-2xl mx-auto">{t('resources.portalsDesc')}</p>
